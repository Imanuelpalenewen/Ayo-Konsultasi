    ...
    <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden h-full flex flex-col transition-colors">
      ...
      <div className="p-0 flex-1 overflow-y-auto">
        {activities.map((activity, i) => (
          <div 
            key={activity.id} 
            className={`p-5 flex items-start gap-4 hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors ${
              i !== activities.length - 1 ? "border-b border-gray-50 dark:border-gray-800" : ""
            }`}
          >
      ...
      <div className="p-4 bg-gray-50/50 dark:bg-gray-800/30 text-center border-t border-gray-100 dark:border-gray-800">
        <button className="text-sm font-semibold text-yellow-600 dark:text-primary hover:underline">
          View all activity
        </button>
      </div>
    </div>
